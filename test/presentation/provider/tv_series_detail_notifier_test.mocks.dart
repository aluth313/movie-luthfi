...
import 'package:ditonton/domain/usecases/get_episodes.dart' as _i13;
...
class MockSaveWatchlistTvSeries extends _i1.Mock
  ...
  _i2.TvRepository get repository =>
      (super.noSuchMethod(Invocation.getter(#repository),
          ...
          as _i2.TvRepository);
  @override
  _i5.Future<_i3.Either<_i6.Failure, String>> execute(_i7.TvDetail? series) =>
...
///
/// See the documentation for Mockito's code generation for more information.
class MockGetEpisodes extends _i1.Mock implements _i13.GetEpisodes {
  MockGetEpisodes() {
    _i1.throwOnMissingStub(this);
  }
      ...
      (super.noSuchMethod(Invocation.method(#execute, [tvId, sessionNumber]),
              returnValue:
                  _i5.Future<_i3.Either<_i6.Failure, List<_i14.Episode>>>.value(
                      _FakeEither_1<_i6.Failure, List<_i14.Episode>>(this,
